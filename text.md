...
Benutzer weiterzugeben, selbst wenn diese nicht auf dem selben Server registriert sind.

# Agenda

Aber nun zur Agenda. Ich habe diese Präsentation in 4 Teile aufgeteilt:
...
4. Und am Ende noch kurz zu den Problemen und ein kurzes Fazit als Abschluss diese 
   Präsentation

# Einführung

Die Idee entstand vor ein paar Jahren als ich auf ein Open-Source Projekt namens ownCloud
gestoßen bin. Diese Idee reifte dann in den letzten Monaten zu meiner Masterarbeit heran. 
...
dann bei klassischen Systemen wie ownCloud oder auch kommerziellen Anbietern nur schwer 
...
Die Kernaussage des Projektes beinhalten 12 Thesen, die zum Teil im heutigen Web Anwendung
...
kann. Es soll dem Anwender die Möglichkeit geben seine Daten privat auf seinem Server zu
...
Prototypen realisiert werden, um die funktionstüchtig zu beweisen.
...
* Mithilfe einer einfachen Variante des Primärbasierten-Backup-Protokolls von XtreemFS werden
  ...
  den Benutzerrechten gesteuert. Was bedeutet, sodass diejenigen Server eine Kopie der Daten
